...
Window_QuestCategory.prototype.initialize = function() {
    Window_HorzCommand.prototype.initialize.call(this, 0, 108);
};
...
Window_QuestCategory.prototype.makeCommandList = function() {
    ...
    this.addCommand(Galv.QUEST.txtCmdFailed,   'failed');
};
...
Scene_QuestLog.prototype.createBackground = function() {
    ...
    this._backgroundSprite1.bitmap = Bitmap.load("img/system/Quest.png");
