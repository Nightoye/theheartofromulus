...
　　var Moghunter = Moghunter || {}; 
  ...
  　Moghunter.parameters = PluginManager.parameters('MOG_SceneItem');
	...
	Moghunter.scItem_ItemCategoryMax = Number(Moghunter.parameters['Max Item Category'] || 4);
...
Scene_Item.prototype.loadBitmaps = function() {
	...
	this._comImg = [];
	for (var i = 0; i < Moghunter.scItem_ItemCategoryMax; i++) {
...
Scene_Item.prototype.createButtons = function() {
    ...
    for (var i = 0; i < Moghunter.scItem_ItemCategoryMax; i++) {
		 ...
		 this._buttons[i].x = Moghunter.scItem_Com1_X + 120*i;
...
Scene_Item.prototype.addCatIndex = function(value) {
	 ...
	 if (this._categoryWindow._index > Moghunter.scItem_ItemCategoryMax-1) {this._categoryWindow._index = 0};
	 if (this._categoryWindow._index < 0) {this._categoryWindow._index = Moghunter.scItem_ItemCategoryMax-1};
...
Scene_Item.prototype.useItem = function() {
	...
	if(this.itemTargetActors().length!=0){this.refreshActorWD();};
};
