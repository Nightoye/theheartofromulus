...
DataManager.processCTBNotetags1 = function(group) {
  ...
  var noteA3 = /<(?:CTB SPEED):[ ](\d+)([%ге])>/i;
  var noteA4 = /<(?:CTB SPEED):[ ]([\+\-]\d+)([%ге])>/i;
  var noteB1 = /<(?:CTB ORDER):[ ]([\+\-]\d+)>/i;
  var noteS1 = /<(?:AFTER CTB):[ ](\d+)>/i;
  var noteS2 = /<(?:AFTER CTB):[ ](\d+)([%ге])>/i;
    for (var n = 1; n < group.length; n++) {
      var obj = group[n];
...
DataManager.processCTBNotetags2 = function(group) {
  ...
  var noteA2 = /<(?:CTB START):[ ]([\+\-]\d+)([%ге])>/i;
  var noteB1 = /<(?:CTB TURN):[ ]([\+\-]\d+)>/i;
  var noteB2 = /<(?:CTB TURN):[ ]([\+\-]\d+)([%ге])>/i;
  for (var n = 1; n < group.length; n++) {
    var obj = group[n];
    var notedata = obj.note.split(/[\r\n]+/);
